    ...
    _data.read('users', phone, (err, userData) => {
      ...
      if (!err && userData) {
        ...
        if (hashedPassword === userData.hashedPassword) {
          ...
          _performance.mark('creting data for the token');
          ...
          _data.create('tokens', tokenId, tokenObject, (err) => {
            ...
            console.log(_performance.nodeTiming);
            console.log(Object.getOwnPropertyNames(_performance));

            var measurements = _performance.getEntries(); // ByType('measure');
            measurements.forEach(measurement => {
              debug.log('\x1b[33m%s\x1b[0m', measurement.name+' '+measurement.duration);
            });
